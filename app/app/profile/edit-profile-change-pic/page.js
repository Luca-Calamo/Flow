...
import styles from "./edit-profile-change-pic.module.css";
import Statusbar from "@/app/components/global-components/statusbar/Statusbar";
import profilePic from "@/public/images/profile.png";
import profilePic02 from "@/public/images/suggest-lazy.png";
        ...
        <div className={externalStyles.ourterContainer}>
            ...
            <div className={styles.overlay}>
                <div className={styles.dialog}>
                    ...
                    <div className={styles.title}>Select an avatar</div>
                    <div className={styles.avatarRow}>
                        <Link href="/profile/edit-profile">
                            <Image src={profilePic} alt="avatar 1" className={styles.avatarImg} />
                        </Link>
                        <Link href="/profile/edit-profile-avatar2">
                            <Image src={profilePic02} alt="avatar 2" className={styles.avatarImg} />
                        </Link>
                    </div>
                </div>
            </div>
